class User {
  ...
  factory User.fromJson(Map<String, dynamic> json) => User(
    ...
    officeTypeName: json["office_type_name"]?.toString(),
    department: json["department"]?.toString(),
    deptName: json["dept_name"]?.toString(),
    phone: json["phone"]?.toString(),
    status: json["status"],
    isDeleted: json["is_deleted"],
    bcAddress: json["bc_address"]?.toString(),
    bcId: json["bc_id"],
    ...
    parafId: json["paraf_id"]?.toString(),
    isSystemSign: json["is_system_sign"],
    signCertStatus: json["sign_cert_status"]?.toString(),
